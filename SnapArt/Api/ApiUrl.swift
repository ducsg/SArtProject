...
//    static let crop_image_url:String = "http://192.168.1.151:8080/snapart/api/cropers/upload"
    ...
    static let get_scale_unit:String = base_url + "api/config/get_scale_unit"
